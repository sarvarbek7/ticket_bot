export const uz = {
  ...
  import_select_date_mode: "Eksport oralig'ini tanlang:",
  import_btn_all_data: "📋 Barcha ma'lumotlar",
  import_btn_by_date: "📅 Sana bo'yicha filtrlash",
  ...
  btn_menu_admin_management: "👤 Adminlar boshqaruvi",
  btn_menu_branch_management: "🏢 Filiallar boshqaruvi",
  btn_menu_manager_management: "👥 Menejerlar boshqaruvi",
  btn_menu_back: "⬅️ Orqaga",
